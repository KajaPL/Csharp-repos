        ...
        static void Main(string[] args)
        {
            ...
            switch (operation)
            {
                ...
                case '*':
                    ...
                    if (multi % 2 == 0)
                    {
                        Console.WriteLine($"{number1} * {number2} = {multi} - even");
                    }
                    else
                    {
                        Console.WriteLine($"{number1} * {number2} = {multi} - odd");
                    }
                    break;
                case '/':                  
                    if (number2 == 0)
                ...
                case '%':
                    ...
                    {
                        double modulation = number1 % number2;
                        Console.WriteLine($"{number1} % {number2} = {modulation}");
                    }
                    break;
